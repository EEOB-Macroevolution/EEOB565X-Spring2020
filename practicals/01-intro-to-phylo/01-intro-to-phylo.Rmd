...
You can find the source files for this tutorial on the class GitHub repository: [https://github.com/EEOB-Macroevolution/EEOB565X-Spring2020/tree/master/practicals/01-intro-to-phylo](https://github.com/EEOB-Macroevolution/EEOB565X-Spring2020/tree/master/practicals/01-intro-to-phylo)
...
The first step is to install the package if it is not already (use `install.packages("ape")`), and load it into the environment. _ape_ is distributed by CRAN, the main package repository for R.

...
Compute the likelihood of the parsimony tree and parsimony branch lenghts. 
...
```{r}
fitGTR <- optim.pml(fitJC, model="GTR")
...
```{r}
plotBS(root(fitGTR$tree,outgroup), bs, p=0, type="phylogram")
```

...
null_rate_matrix <- ParDrop(null_rate_matrix, c(3,5,8,10))
```
...
null_incorrect_hisse = hisse(tree_bisse, incorrect_hisse_states, hidden.states=TRUE, turnover.anc = null_net_turnover, eps.anc = null_extinction_fraction, trans.rate = null_rate_matrix)
```

And again we can compare the AIC values obtained.

```{r}
null_incorrect_hisse$AIC
